...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SMPhotoEditorSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/dongka195@live.com/SMPhotoEditorSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dongka195@live.com' => 'dongka195@live.com' }
  s.source           = { :git => 'https://github.com/dongka195@live.com/SMPhotoEditorSDK.git', :tag => s.version.to_s }
